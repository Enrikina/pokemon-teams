...
def get_game_images() -> None:
    with open('assets\pokemon_data\local_dexes\\hgss.yaml', 'r') as file:
        local_dex = yaml.safe_load(file)  # Returns a dict

    site_prefix ='https://img.pokemondb.net/sprites/heartgold-soulsilver/normal/'
    site_suffix = '.png'
    ...
    for dex_num, name in local_dex.items():
        ...
        if response.status_code == 200:
            ...
            with open('assets\pokemon_data\sprites\\hgss\\' + name.lower() + '.png', "wb") as f:
